		...
		<div class="comment-text">
			<div class="dfd-comment-heading-wrap">
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<p class="meta subtitle"><?php _e( 'Your comment is awaiting approval', 'woocommerce' ); ?></p>
				<?php else : ?>
					...
					?><time itemprop="datePublished" datetime="<?php echo get_comment_date( 'c' ); ?>" class="subtitle left"><?php echo get_comment_date( wc_date_format() ); ?></time>
				<?php endif; ?>
