...
//		@ini_set('max_execution_time', 300);
	...
	public function upload_max_filesize() {
		...
		$pr = array ("upload_max_filesize", "Recomended min value 30M ", 1);
		$check = intval($val);
