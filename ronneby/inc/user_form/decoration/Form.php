...
class Dfd_Simple_FormDecorator extends Dfd_Abstract_FormDecorator {
	...
	function generate($content) {
		...
		<div class="wpb_wrapper <?php echo $el_class; ?>" <?php echo $animation_data; ?>>
			<div class="wpcf7">
				<div class="">
					<form action="validate" method="post" onsubmit="yaCounter39882000.reachGoal('order1'); return true;" id="cf_<?php echo $form_id; ?>" class="wpcf7-form dfd_contact_form <?php echo $general_class; ?> cf_<?php echo $form_id; ?>" >
						<div class="container">
							<?php
							$class = "";
