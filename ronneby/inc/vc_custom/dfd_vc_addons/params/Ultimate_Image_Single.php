...
if(!class_exists('Ult_Image_Single'))
{
  class Ult_Image_Single
  {
    function __construct()
    {
		...
		{
			  vc_add_shortcode_param('ult_img_single', array($this, 'ult_img_single_callback'), get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/vc_extend/js/ultimate-image_single.js');
		}
    ...
    function image_single_scripts() {
		wp_enqueue_media();
		wp_enqueue_style( 'ultimate_image_single_css', get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/vc_extend/css/ultimate_image_single.css');
    }
