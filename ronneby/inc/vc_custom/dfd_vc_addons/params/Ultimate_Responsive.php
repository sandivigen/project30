	...
	class Ultimate_Responsive {
		function __construct() {
			...
			if(function_exists('vc_add_shortcode_param')) {
				vc_add_shortcode_param('ultimate_responsive', array($this, 'ultimate_responsive_callback'), get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/vc_extend/js/ultimate-responsive.js');
			}
		}
		...
		function ultimate_admin_responsive_param_scripts($hook) {
			...
			wp_register_style('ultimate_responsive_param_css', get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/vc_extend/css/ultimate_responsive.min.css');
