							...
							array(
								...
								'options'     => array(
									'style-1' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_cat/style-1.png'
									),
									'style-2' => array(
										'tooltip' => esc_attr__('Fade in','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_cat/style-2.png'
									),
									'style-3' => array(
										'tooltip' => esc_attr__('Fade out','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_cat/style-3.png'
									),
								),
								'group' => esc_attr__('General', 'dfd'),
							),
