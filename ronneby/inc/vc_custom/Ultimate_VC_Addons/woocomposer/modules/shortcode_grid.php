							...
							array(
								...
								'options'     => array(
									'style-1' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_list/style-1.png'
									),
									'style-2' => array(
										'tooltip' => esc_attr__('Advanced','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_list/style-2.png'
									),
									'style-3' => array(
										'tooltip' => esc_attr__('Full','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_list/style-3.png'
									),
								),
							),
							array(
