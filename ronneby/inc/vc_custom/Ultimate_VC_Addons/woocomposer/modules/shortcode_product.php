							...
							array(
								...
								'options'     => array(
									'style-1' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_single/style-1.png'
									),
									'style-2' => array(
										'tooltip' => esc_attr__('Full width image hover description','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/woo_single/style-2.png'
									),
								),
