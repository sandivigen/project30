						...
						array(
							...
							'options'      => array(
								'horizontal' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/slide_parallax/horizontal.png'
									),
								'vertical' => array(
										'tooltip' => esc_attr__('Vertical','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/slide_parallax/vertical.png'
									),
							),
						),
//						array(
