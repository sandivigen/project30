<?php
// VC module for info baner in hompage and catalog page
// update 15.09.16
?>
<?php
		...
		function dfd_info_banner_form( $atts, $content = null ) {
			...
			switch ( $style ) {
				...
				case 'style-02':
					...
					// custom code
					if ($link['url'] == 'http://www.inhuk.ru/kuhni-e`mal/') { // fix bug url path
						$output .= '<div class="image-wrap"><a href="http://www.inhuk.ru/kuhni-emal/">';
					} else {
						$output .= '<div class="image-wrap"><a href="'.$link['url'].'">'; // add link for image
					}
