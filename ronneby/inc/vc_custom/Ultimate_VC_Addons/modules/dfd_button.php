						...
						array(
							...
							'options'      => array(
								'style_1' => array(
									...
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/button/style_1.png'
								),
								'style_2' => array(
									'tooltip' => esc_attr__('Slide','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/button/style_2.png'
								),
								'style_3' => array(
									'tooltip' => esc_attr__('Scale out','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/button/style_3.png'
								),
								'style_4' => array(
									'tooltip' => esc_attr__('Scale in','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/button/style_4.png'
								),
								'style_5' => array(
									'tooltip' => esc_attr__('Zoom in','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/button/style_5.png'
								),
								'style_6' => array(
									'tooltip' => esc_attr__('3D rotate','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/button/style_6.png'
								),
							),
						),
						/*
