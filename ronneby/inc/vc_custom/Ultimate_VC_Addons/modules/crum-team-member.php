...
if ( ! class_exists( 'Dfd_Team_Member' ) ) {
	...
	class Dfd_Team_Member {
		...
		function __construct() {
			add_action( 'vc_before_init', array( &$this, 'dfd_team_member_init' ) );
		...
		function dfd_team_member_init() {
			...
			$module_images = get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/team_member/';
