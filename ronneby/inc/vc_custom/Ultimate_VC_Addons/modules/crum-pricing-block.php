...
if ( ! class_exists( 'Dfd_Pricing_Block' ) ) {
	...
	class Dfd_Pricing_Block {
		...
		function __construct() {
			add_action( 'vc_before_init', array( &$this, 'dfd_pricing_block_init' ) );
		...
		function dfd_pricing_block_init() {
			...
			$module_images = get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/pricing/';
