						...
						array(
							...
							'options'      => array(
								'chaffle' => array(
									...
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/animated_text/chaffle.png'
								),
								'typed' => array(
									'tooltip' => esc_attr__('Typing','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/animated_text/typed.png'
								),
								'changethewords' => array(
									'tooltip' => esc_attr__('Changing words','dfd'),
									'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/animated_text/changethewords.png'
								),
							),
						),
						/*
