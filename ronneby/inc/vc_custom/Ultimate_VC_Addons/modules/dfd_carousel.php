							...
							array(
								...
								'options'     => array(
									'horizontal' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/horizontal.png'
									),
									'vertical' => array(
										'tooltip' => esc_attr__('Vertical','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/vertical.png'
									),
								),
								'group'            => esc_attr__( 'General', 'dfd' ),
							),
							...
							*/
							...
							array(
								...
								'options'     => array(
									'aside_offset' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/aside_offset.png'
									),
									'aside' => array(
										'tooltip' => esc_attr__('Aside','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/aside.png'
									),
									'top_left' => array(
										'tooltip' => esc_attr__('Top left','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/top_left.png'
									),
									'top_center' => array(
										'tooltip' => esc_attr__('Top center','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/top_center.png'
									),
									'top_right' => array(
										'tooltip' => esc_attr__('Top right','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/top_right.png'
									),
									'bottom_left' => array(
										'tooltip' => esc_attr__('Bottom left','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/bottom_left.png'
									),
									'bottom_center' => array(
										'tooltip' => esc_attr__('Bottom center','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/bottom_center.png'
									),
									'bottom_right' => array(
										'tooltip' => esc_attr__('Bottom right','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows_position/bottom_right.png'
									),
								),
							...
							array(
								...
								'options'     => array(
									'style_1' => array(
										'tooltip' => esc_attr__('Aside','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows/style_1.png'
									),
									'style_2' => array(
										'tooltip' => esc_attr__('Aside','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows/style_2.png'
									),
									'style_3' => array(
										'tooltip' => esc_attr__('Aside','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows/style_3.png'
									),
									'style_4' => array(
										'tooltip' => esc_attr__('Aside','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows/style_4.png'
									),
									'style_5' => array(
										'tooltip' => esc_attr__('Aside','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/arrows/style_5.png'
									),
								),
							...
							array(
								...
								'options'     => array(
									'dfdrounded' => array(
										...
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_1.png'
									),
									'dfdfillrounded' => array(
										'tooltip' => esc_attr__('Filled rounded','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_2.png'
									),
									'dfdemptyrounded' => array(
										'tooltip' => esc_attr__('Transparent rounded','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_3.png'
									),
									'dfdfillsquare' => array(
										'tooltip' => esc_attr__('Filled square','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_6.png'
									),
									'dfdsquare' => array(
										'tooltip' => esc_attr__('Square','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_7.png'
									),
									'dfdemptysquare' => array(
										'tooltip' => esc_attr__('Transparent square','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_8.png'
									),
									'dfdline' => array(
										'tooltip' => esc_attr__('Line','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_4.png'
									),
									'dfdadvancesquare' => array(
										'tooltip' => esc_attr__('Advanced square','dfd'),
										'src' => get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/carousel/dots/style_5.png'
									),
								),
