	...
	class Dfd_Countdown {
		...
		function _dfd_countdown_init() {
			if ( function_exists( 'vc_map' ) ) {
				$module_images = get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/img/countdown/';
				vc_map(
					array(
		...
		function _dfd_countdown_shortcode( $atts ) {
			...
			wp_enqueue_script('countdown-js',get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/jquery.countdown.min.js',array('jquery'));
