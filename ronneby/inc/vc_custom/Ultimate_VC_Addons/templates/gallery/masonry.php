...
<div class="dfd-gallery-loop dfd-gallery-module <?php echo esc_attr($el_class) ?>" id="<?php echo esc_attr($uniqid) ?>">
	<div class="dfd-gallery-wrap">
		<?php
			if($sort_panel)
				include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/gallery/template_parts/sort-panel.php'));
		?>
		
		<div class="dfd-gallery dfd-gallery-<?php echo esc_attr($style .' '.$extra_class_name) ?>" <?php echo $data_atts ?>>
		<?php
			...
			while ($wp_query->have_posts()) : $wp_query->the_post();
				...
				if($sort_panel)
					include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/gallery/template_parts/article_data_atts.php'));
				?>
					...
					<div class="cover <?php echo esc_attr($content_alignment) ?>">
						<div class="dfd-gallery-inner-wrap">
							...
							if(isset($title_position) && $title_position == 'top')
								include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/gallery/template_parts/heading.php'));
							...
							<div class="entry-thumb <?php echo esc_attr($media_class) ?>">
								...
								<?php include(locate_template('inc/vc_custom/Ultimate_VC_Addons/templates/gallery/template_parts/comments_likes.php')); ?>
