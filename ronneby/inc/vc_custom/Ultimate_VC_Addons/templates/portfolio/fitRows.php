<?php
// VC module for loop in category citchen
// update 15.09.16
?>
<?php
$extra_class_name = '';
			...
			while ($wp_query->have_posts()) : $wp_query->the_post();
				...
				<div class="<?php echo esc_attr($post_class) ?>" <?php echo $article_data_atts; ?>>
					<div class="cover <?php echo esc_attr($content_alignment) ?>">
						...
						<?php 
							// Custom code for display price block
							...
							<div class="wpb_wrapper">
								<div id="dfd-pricing-block-57c57987c4a6a-9487" class="dfd-pricing-block style-02 " solid="">
									<div class="block-head  ">
										<div class="icon-wrap">
											<div class="feature-title" style=""><a href="<?php echo $permalink; ?>"><?php the_title(); ?></a></div>
											...
											<div class="price-wrap">
												...
												<span class="payment-amount">
													<?php echo substr($price['price'][0], 0, 2); ?>
