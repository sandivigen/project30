	...
	class Dfd_Delimiter {
		function __construct() {
			...
			if(function_exists('vc_add_shortcode_param')) {
				vc_add_shortcode_param('dfd_delimiter', array($this, 'dfd_delimiter_param'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/dfd_delimiter.js');
			}
		}
		...
		function dfd_delimiter_param_scripts($hook) {
			wp_register_style('dfd-delimiter-style',get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/css/dfd-delimiter.css');
