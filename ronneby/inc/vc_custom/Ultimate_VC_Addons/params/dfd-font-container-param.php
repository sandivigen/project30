	...
	class Crum_Font_Container {
		...
		function __construct() {
			if ( function_exists( 'vc_add_shortcode_param' ) ) {
				vc_add_shortcode_param( 'crumina_font_container', array( $this, 'vc_font_container_form_field' ), get_template_directory_uri() . '/inc/vc_custom/Ultimate_VC_Addons/admin/js/crum_additional_param.js' );
			}
		}
