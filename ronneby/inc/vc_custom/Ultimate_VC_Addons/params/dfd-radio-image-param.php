	...
	class Crum_Radio_Image_Param {
		...
		function __construct() {
			if ( function_exists( 'vc_add_shortcode_param' ) ) {
				vc_add_shortcode_param( 'radio_image_select', array( &$this, 'radio_image_settings_field' ), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/js/crum_additional_param.js' );
			}
		}
