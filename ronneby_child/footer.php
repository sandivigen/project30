...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter39882000 = new Ya.Metrika({
                    id:39882000,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/39882000" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<!-- Custom scricpt - arroy left for single post -->
<script type="text/javascript">jQuery('.dfd-controler.prev span').html('<i class="dfd-icon-left_2"></i>');</script>
<script type="text/javascript">jQuery('.dfd-controler.next span').html('<i class="dfd-icon-right_2"></i>');</script>
<!-- Click for info-banner on hompage-->
<script type="text/javascript">
	// jQuery('.dfd-info-banner.style-02 .image-wrap').click(function(){
 //   		document.location.href = jQuery(this).siblings(".dfd-module-readmore").children('.read-more-01').attr('href');
	// })  
</script>
<!-- Portfolio single changes -->
<script type="text/javascript">
	jQuery(".pricing-button").on('click', jQuery('button.overlay-show'));

	// jQuery(jQuery(".folio-field-name")[0]).text(jQuery(".dfd-blog-title a").text());
	// jQuery(jQuery(".folio-field-name")[1]).text('Цена');
	// jQuery(jQuery(".folio-field-name")[2]).text('Сделать заказ');
</script>
<!-- <link rel="stylesheet" href="https://cdn.callbackkiller.com/widget/cbk.css">
<script type="text/javascript" src="https://cdn.callbackkiller.com/widget/cbk.js?wcb_code=a7bff388489c80be082c597af218cb75" charset="UTF-8" async></script>
 -->
<?php wp_footer(); ?>
